...
//    
  public function fm_cancelarref($mvidrefrigerio,$mvidrequeriiento,$mvidevaluacion,$mvidaprobado)
    {
        $this->db->query('call spcancelarref('.$mvidrefrigerio.','.$mvidrequeriiento.','.$mvidevaluacion.','.$mvidaprobado.');');
