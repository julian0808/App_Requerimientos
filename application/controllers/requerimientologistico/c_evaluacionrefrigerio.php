...
$titulo ='';   
    ...
    public function fc_cancelarref()
    {
        $cvidrefrigerio= $this->input->get('vidrefrigerio');
...
$this->m_evaluacionrefrigerio->fm_cancelarref($cvidrefrigerio,$cvidrequeriiento,$cvidevaluacion,$cvidaprobado);
     ...
     public function fc_filtrotabla()
  {
         ...
         $datos = '';
           ...
           $inhabilitarespuesta = ' ';
            ...
            $observacionevaluador ='<div class=" col-md-12"   ><textarea class="form-control" '.$inhabilitarespuesta2.' '.$inhabilitarespuesta.' id="observacionad'.$valor->idrefrigerio.'"  name="observacionad'.$valor->idrefrigerio.'" rows="2">'.$valor->observacionevaluadorr.'</textarea> </div>' ;
 
            $respuestaevaluador = '<select class="form-control input-sm  " '.$inhabilitarespuesta2.'   '.$inhabilitarespuesta.' id="respuestaevaluacion'.$valor->idrefrigerio.'" name="respuestaevaluacion'.$valor->idrefrigerio.'"  >';
...
//style="display:none"
           ...
           $comilla = "'";
            $datos .=  '<tr '.$colorfila.'>'
                        ...
                        .'<td>'.$observacionevaluador.'</td>'
                        //.'<td><a class="btn btn-success btn-sm fancybox" '.$archivo.' id="editar" href="'.DESCARGAR.'/'.$valor->nombre_archivo.'" role="button"><span class="glyphicon glyphicon-download"></span> Descargar</a></td>'
                        .'<td><button type="button" id="guardarevaluacionrefrigerio" '.$cancelado.' '.$inhabilitarespuesta.' onclick="fc_guardarevaluacionrefrigerio('.$comilla.$valor->idrefrigerio.$comilla.')" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span> Guardar </button></td>'
                        .'<td><button type="button" '.$cancelado2.' '.$cancelado.' '.$cancelado3.' id="cancelarrefrigerio"  onclick="cancelarref('.$comilla.$valor->idrefrigerio.$comilla.')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-remove-sign"></span> Cancelar </button></td>';
