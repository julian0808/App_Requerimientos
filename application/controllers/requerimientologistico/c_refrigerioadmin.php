...
//            }
     ...
     public function fc_filtrotabla()
  {
         ...
         $datos = '';
            ...
            $observacionadmin ='<div class=" col-md-12" ><textarea class="form-control" '.$inhabilitarespuesta2.' '.$inhabilitarespuesta.' id="observacionad'.$valor->idrefrigerio.'"  name="observacionad'.$valor->idrefrigerio.'" rows="2">'.$valor->observacionadminr.'</textarea> </div>' ;
 
            $respuesta = '<select class="form-control input-sm  "  '.$inhabilitarespuesta2.' '.$inhabilitarespuesta.' id="respuestaadmin'.$valor->idrefrigerio.'" name="respuestaadmin'.$valor->idrefrigerio.'"  >';
...
//style="display:none"
           ...
           $datos .=  '<tr '.$colorfila.'>'
                   ...
                   .'<td>'.$valor->estadorequerimiento.'</td>'
                        ...
                        .'<td>'.$valor->observacionr.'</td>'
                        .'<td>'.$valor->fecharegistro.'</td>'
                         .'<td><a class="btn btn-success btn-sm fancybox" id="editar" '.$esconde.' '.$cancelado.' href="'.DESCARGAR.'/'.$valor->archivo_refrigerio.'" role="button"><span class="glyphicon glyphicon-download"></span> Descargar</button></td>'
                        .'<td>'.$respuesta.'</td>'
                        .'<td>'.$observacionadmin.'</td>'
                        //.'<td><a class="btn btn-success btn-sm fancybox" '.$archivo.' id="editar" href="'.DESCARGAR.'/'.$valor->nombre_archivo.'" role="button"><span class="glyphicon glyphicon-download"></span> Descargar</a></td>'
                        .'<td><button type="button" id="guardarrefrigerioadmin" '.$cancelado.' '.$inhabilitarespuesta.' onclick="fc_guardarrefrigerioadmin('.$comilla.$valor->idrefrigerio.$comilla.')" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span> Guardar </button></td>';
