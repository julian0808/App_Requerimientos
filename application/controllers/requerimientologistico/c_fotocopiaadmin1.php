...
//            }
     ...
     public function fc_filtrotabla()
  {
         ...
         $datos = '';
            ...
            $observacionadmin ='<div class=" col-md-12" ><textarea class="form-control" '.$inhabilitarespuesta.' id="observacionad'.$valor->idfotocopia.'"  name="observacionad'.$valor->idfotocopia.'" rows="2">'.$valor->observacionadminf.'</textarea> </div>' ;
 
            $respuesta = '<select class="form-control input-sm  " '.$inhabilitarespuesta.' id="respuestaadmin'.$valor->idfotocopia.'" name="respuestaadmin'.$valor->idfotocopia.'"  >';
...
//style="display:none"
            ...
            $datos .=  '<tr '.$colorfila.'>'
                   ...
                   .'<td>'.$valor->estadorequerimiento.'</td>'
                        ...
                        .'<td>'.$valor->observacion_fotocopia.'</td>'
                        .'<td>'.$valor->fecharegistro.'</td>'
                    .'<td><a class="btn btn-success btn-sm fancybox" id="editar" href="'.DESCARGAR.'/'.$valor->archivo_fotocopia.'" role="button"><span class="glyphicon glyphicon-download"></span> Descargar</button></td>'
                        .'<td>'.$respuesta.'</td>'
                        .'<td>'.$observacionadmin.'</td>'
                        //.'<td><a class="btn btn-success btn-sm fancybox" '.$archivo.' id="editar" href="'.DESCARGAR.'/'.$valor->nombre_archivo.'" role="button"><span class="glyphicon glyphicon-download"></span> Descargar</a></td>'
                        .'<td><button type="button" id="guardarfotocopiaadmin" '.$inhabilitarespuesta.' onclick="fc_guardarfotocopiaadmin('.$comilla.$valor->idfotocopia.$comilla.')" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span> Guardar </button></td>';
