...
class  C_papeleria extends CI_Controller {
    ...
    public function fc_papeleria($page = 'v_papeleria') {
        ...
        $carraydatospapeleria = array('fechap' => '', 'horap' =>'','toner' =>'',  'cantidadp' => '','archivo_papeleria' => '','observacionp' => ''); 
    ...
    public function fc_guardarpapeleria()
    {
       ...
       $cidpapeleria = $this->m_papeleria->fm_guardarpapeleria($cvdocumento,$cvfechasp,$cvhorasp,$ctoner,$cvcantidadp,$cvnameFile,$cvobservacionp);
