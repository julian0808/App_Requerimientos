...
$titulo ='';    
     ...
     public function fc_filtrotabla()
  {
         ...
         $datos = '';
            ...
            $observacionadmin ='<div class=" col-md-12" ><textarea class="form-control" id="observacionad'.$valor->id_transporte.'" '.$inhabilitarespuesta.'  name="observacionad'.$valor->id_transporte.'" rows="2">'.$valor->observacion_admin.'</textarea> </div>' ;
 
            $respuesta = '<select class="form-control input-sm  "  '.$inhabilitarespuesta.' id="respuestaadmin'.$valor->id_transporte.'" name="respuestaadmin'.$valor->id_transporte.'"  >';
...
//style="display:none"
            ...
            $datos .=  '<tr '.$colorfila.'>'
                   ...
                   .'<td>'.$valor->estadorequerimiento.'</td>'
                        ...
                        .'<td>'.$observacionadmin.'</td>'
                        //.'<td><a class="btn btn-success btn-sm fancybox" '.$archivo.' id="editar" href="'.DESCARGAR.'/'.$valor->nombre_archivo.'" role="button"><span class="glyphicon glyphicon-download"></span> Descargar</a></td>'
                        .'<td><button type="button" id="guardartransporteadmin" '.$inhabilitarespuesta.' onclick="fc_guardartransporteadmin('.$comilla.$valor->id_transporte.$comilla.')" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span> Guardar </button></td>';
