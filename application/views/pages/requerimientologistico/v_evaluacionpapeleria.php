...
<hr>
  ...
  <div class="row">
      ...
      <div class="col-md-2">
          <input type="text" class="form-control input-sm" id="buscaridpapeleria" onchange="deshabilitarbuscar()" name="buscaridpapeleria"  placeholder="DIGITE ID TRANSPORTE" value="">
      </div>
                            ...
                            <thead>
                              <tr class="success">
                               <th style="width:100px;">Id Requerimiento</th>
                                  <th style="width:100px;">Estado </th>
                                  <th style="width:100px;">Nombre</th>
                                  <th style="width:100px;">Fecha Papeleria</th>
                                  <th style="width:100px;">Cantidad</th>
                                  <th style="width:200px;">Observacion</th>
                                  <th style="width:300px;">Respuesta admin</th>
                                  <th style="width:300px;">Observacion admin</th>
       ...
       $.ajax({
        ...
        { mensajedesinco();
                        $.ajax({
                          ...
                          vbuscaridpapeleria : $('#buscaridpapeleria').val(),
           ...
           function cancelarpap(idpapeleria)
{
    
                        $.ajax({
                          url: "fc_cancelarpap",
                          type: "GET",
                          data: {vidpapeleria :  idpapeleria,
                                 vidrequeriiento : '4',
                                 videvaluacion : '4' ,
                                 vidaprobado : '4' 
...
function fc_guardarevaluacionpapeleria(idpapeleria)
{
    
                        $.ajax({
                          url: "fc_guardarevaluacionpapeleria",
                          type: "GET",
                          data: {vidpapeleria :  idpapeleria,
                                 vrespuestaevaluacion : $('#respuestaevaluacion' + idpapeleria).val(),
                                 vobservacionad : $('#observacionad' + idpapeleria).val()
                                 },    
                          dataType: "html",
                          success : function(obj){   
...
function deshabilitarbuscar()
    {
        if(($('#buscarfecha').val() !== '') || ($('#buscaridpapeleria').val() !=='') || ($('#estadorequerimiento').val() !=='') )
        {
            $('#buscar').prop('disabled',false);  
        }
        else
