...
<!--        <input type="text" class="form-control input-sm" id="idfotocopia" name="idfotocopia" style="display: none"     placeholder="rol" value="<?php echo($idfotocopia); ?>">-->
...
<div class="row">
    <div class="col-md-2 ">
        <label>id fotocopia</label><br>
        <input type="text" class="form-control input-sm" id="idfotocopia" name="idfotocopia" style="display:none"  placeholder="documento" value="<?php echo($idfotocopia); ?>"><?php echo($idfotocopia); ?>
    </div>
     <div class="col-md-2">
...
<div class="row ">
     ...
     <div id="fechasfdiv" <?php if($carraydatosfotocopia['fechaf']==''){echo('class="col-md-2 col-md-offset-2 has-error"');}else{echo('class="col-md-2 col-md-offset-2"');} ?>>
         <label class="control-label">Fecha del servicio</label><br>
         <input type="date" class="form-control input-sm" id="fechasf" name="fechasf" onchange="validarbolitasytextoformulario('fechasfdiv','fechasf')" onkeyup="eliminardigito()"  placeholder="fechasf" value="<?php  echo($carraydatosfotocopia['fechaf']); ?>">
    </div>
    
    <div id="horasfdiv" <?php if($carraydatosfotocopia['horaf']==''){echo('class="col-md-2 has-error"');}else{echo('class="col-md-2"');} ?>>
        <label class="control-label">Hora del servicio</label><br>
        <input type="time" class="form-control input-sm" id="horasf" name="horasf" onchange="validarbolitasytextoformulario('horasfdiv','horasf')"   placeholder="horasf" value="<?php  echo($carraydatosfotocopia['horaf']); ?>">
    </div>
    ...
    <div id="cantidadpfdiv" <?php if($carraydatosfotocopia['cantidadf']==''){echo('class="col-md-2 has-error"');}else{echo('class="col-md-2"');} ?>>
        <label class="control-label">Cantidad</label><br>
        <input type="text" class="form-control input-sm" id="cantidadpf" onkeypress="return soloNumeros(event)" name="cantidadpf" onchange="validarbolitasytextoformulario('cantidadpfdiv','cantidadpf')"  placeholder="Digite lugar de salida" value="<?php  echo($carraydatosfotocopia['cantidadf']); ?>">
    </div>
...
<div id="observacionfdiv" class="row  " >
      
          <label class="col-md-offset-5 control-label">Observacion</label><br>
          <textarea class="form-control" id="observacionf" onchange="validarbolitasytextoformulario('observacionfdiv','observacionf')" name="observacionf" rows="4"><?php  echo($carraydatosfotocopia['observacionf']); ?></textarea>              
...
<div class="row">
    <div class="col-md-2 col-md-offset-5">
        <button type="button" id="guardarfotocopia" disabled="disabled"  name="guardarfotocopia" class="btn btn-primary">Guardar</button>
...
{ //alert(div + ' juanpis ' + campo);
   ...
   { 
    ...
    validarguardarfotocopia();
}


function validarguardarfotocopia()
{
    if ($('#fechasf').val() != '' && $('#horasf').val() != '' && $('#lugarpsr').val() != ''&& $('#lugarlsr').val() != '' && $('#cantidadpf').val() != '' && $('#tipofotocopia').val() != '' )
        
    {
       $('#guardarfotocopia').prop('disabled', false);
           
   }
   else
   {
       $('#guardarfotocopia').prop('disabled', true);
    ...
    //NO TOCAR - voler a capitulos                
        ...
        $("#guardarfotocopia").click(function ()
        {
                        $.ajax({
                          url: "fc_guardarfotocopia",
                          type: "GET",
                          data: {vdocumento : $('#documento').val(),
                                 vfechasf : $('#fechasf').val(),
                                 vhorasf : $('#horasf').val(),
                                 vcantidadpf : $('#cantidadpf').val(),
                                 vnameFile : $('#nameFile').val(),
                                 vobservacionf : $('#observacionf').val()},    
                          dataType: "html",
                          success : function(obj){   
                              location.href = "../c_fotocopia/fc_fotocopia?idfotocopia="+ obj;
                          botonguardar();
        ...
        $("#actualizar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(), vvalorfotocopia : $('#valorfotocopia').val()},    
                          dataType: "html",
                          success : function(obj){                      
                          botonactualizar();
                          }
