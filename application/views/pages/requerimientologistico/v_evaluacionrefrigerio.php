...
<div class="row">
    <div class="col-md-6 col-md-offset-4">
        <h1>Evaluacion de Refrigerio</h1>
    </div>
</div><br><br><br>
...
<hr>
  ...
  <div class="row">
      ...
      <div class="col-md-2">
          <input type="text" class="form-control input-sm" id="buscaridrefrigerio" onchange="deshabilitarbuscar()" name="buscaridrefrigerio"  placeholder="DIGITE ID TRANSPORTE" value="">
      </div>
...
<!--                                        <table class="table table-bordered table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Estado req</th>
                                                    <th>Nombre</th>
                                                    <th>Fecha Refrigerio</th>
                                                    <th>Hora de Refrigerio</th>
                                                    <th>Lugar Refrigerio</th>
                                                    <th>Cantidad</th>
                      ...
                      <table class="table table-bordered" id="tr24h2" style="table-layout: fixed">
                          <thead>
                              <tr class="success">
                                  ...
                                  <th style="width:100px;">Fecha Refrigerio</th>
                                  <th style="width:100px;">Hora de Refrigerio</th>
                                  <th style="width:200px;">Lugar Refrigerio</th>
                                  <th style="width:300px;">Cantidad</th>
                                  <th style="width:300px;">Respuesta admin</th>
                                  <th style="width:120px;">Observacion Admin</th>
                                  <th style="width:150px;">Estado Evaluacion</th>
                                  <th style="width:200px;">respuesta evaluador</th>
...
function salir()
       ...
       $.ajax({
        ...
        { mensajedesinco();
                        $.ajax({
                          ...
                          vbuscaridrefrigerio : $('#buscaridrefrigerio').val(),
 ...
 function cancelarref(idrefrigerio)
{
    
                        $.ajax({
                          url: "fc_cancelarref",
                          type: "GET",
                          data: {vidrefrigerio :  idrefrigerio,
                                 vidrequeriiento : '4',
                                 videvaluacion : '4' ,
                                 vidaprobado : '4' 
...
function fc_guardarevaluacionrefrigerio(idrefrigerio)
{
    
                        $.ajax({
                          url: "fc_guardarevaluacionrefrigerio",
                          type: "GET",
                          data: {vidrefrigerio :  idrefrigerio,
                                 vrespuestaevaluacion : $('#respuestaevaluacion' + idrefrigerio).val(),
                                 vobservacionad : $('#observacionad' + idrefrigerio).val()
                                 },    
                          dataType: "html",
                          success : function(obj){   
...
function deshabilitarbuscar()
    {
        if(($('#buscarfecha').val() !== '') || ($('#buscaridrefrigerio').val() !=='') || ($('#estadorequerimiento').val() !=='') )
        {
            $('#buscar').prop('disabled',false);  
        }
        else
