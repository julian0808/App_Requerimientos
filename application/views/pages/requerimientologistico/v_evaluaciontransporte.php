...
<!--        <input type="text" class="form-control input-sm" id="idevaluaciontransporte" name="idevaluaciontransporte" style="display: none"     placeholder="rol" value="<?php echo($idevaluaciontransporte); ?>">-->
...
<div class="row">
    <div class="col-md-6 col-md-offset-4">
        <h1>Evaluacion de Transporte</h1>
    </div>
</div><br><br><br>
...
function salir()
   {
       ...
       $.ajax({
        ...
        { mensajedesinco();
         ...
         function cancelartrans(idtransporte)
{
    
                        $.ajax({
                          url: "fc_cancelartrans",
                          type: "GET",
...
{ //alert(div + ' juanpis ' + campo);
   ...
   { 
    ...
    validarguardarevaluaciontransporte();
}


function validarguardarevaluaciontransporte()
{
    if ($('#fechast').val() != '' && $('#horast').val() != '' && $('#lugarpst').val() != ''&& $('#lugarlst').val() != '' && $('#cantidadpt').val() != '' && $('#estadot').val() != '' )
        
    {
       $('#guardarevaluaciontransporte').prop('disabled', false);
           
   }
   else
   {
       $('#guardarevaluaciontransporte').prop('disabled', true);
...
function fc_guardarevaluaciontransporte(idtransporte)
{
    
                        $.ajax({
                          url: "fc_guardarevaluaciontransporte",
                          type: "GET",
                          data: {vidtransporte :  idtransporte,
                                 vrespuestaevaluacion : $('#respuestaevaluacion' + idtransporte).val(),
                                 vobservacionad : $('#observacionad' + idtransporte).val()
                                 },    
                          dataType: "html",
                          success : function(obj){   
    ...
    //NO TOCAR - voler a capitulos                
        ...
        $("#actualizar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(), vvalorevaluaciontransporte : $('#valorevaluaciontransporte').val()},    
                          dataType: "html",
                          success : function(obj){                      
                          botonactualizar();
                          }
