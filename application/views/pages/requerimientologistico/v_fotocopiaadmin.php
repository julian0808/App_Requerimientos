...
<!--        <input type="text" class="form-control input-sm" id="idfotocopiaadmin" name="idfotocopiaadmin" style="display: none"     placeholder="rol" value="<?php echo($idfotocopiaadmin); ?>">-->
                      ...
                      <table class="table table-bordered" id="tr24h2" style="table-layout: fixed">
                          <thead>
                              <tr class="success">
                                  ...
                                  <th style="width:100px;">Hora de Fotocopia</th>
...
{ //alert(div + ' juanpis ' + campo);
   ...
   { 
    ...
    validarguardarfotocopiaadmin();
}


function validarguardarfotocopiaadmin()
{
    if ($('#fechast').val() != '' && $('#horast').val() != '' && $('#lugarpst').val() != ''&& $('#lugarlst').val() != '' && $('#cantidadpt').val() != '' && $('#estadot').val() != '' )
        
    {
       $('#guardarfotocopiaadmin').prop('disabled', false);
           
   }
   else
   {
       $('#guardarfotocopiaadmin').prop('disabled', true);
...
function fc_guardarfotocopiaadmin(idfotocopia)
{
    administrativomail(idfotocopia, 'Fotocopias');
    
                        $.ajax({
                          url: "fc_guardarfotocopiaadmin",
                          type: "GET",
                          data: {vidfotocopia:  idfotocopia,
                                 vrespuestaadmin : $('#respuestaadmin' + idfotocopia).val(),
                                 vobservacionad : $('#observacionad' + idfotocopia).val()
                                 },    
                          dataType: "html",
                          success : function(obj){   
                              //location.href = "../c_fotocopiaadmin/fc_fotocopiaadmin?idfotocopiaadmin="+ obj;
                          filtrartabla();
                          botonguardar();
                          }
                        });                    
    ...
    //NO TOCAR - voler a capitulos                
        ...
        $("#actualizar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(), vvalorfotocopiaadmin : $('#valorfotocopiaadmin').val()},    
                          dataType: "html",
                          success : function(obj){                      
                          botonactualizar();
                          }
