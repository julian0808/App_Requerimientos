...
<!--        <input type="text" class="form-control input-sm" id="folio" name="folio"  style="display:none"   placeholder="folio" value="<?php echo($folio); ?>">-->
        <input type="text" class="form-control input-sm" id="rol" style="display:none" name="rol" placeholder="rol" value="<?php echo($crol); ?>">
        <input type="text" class="form-control input-sm" id="apellido" style="display:none" name="apellido" placeholder="apellido" value="<?php echo($carraydatosgenerales['eapellido1']); ?>">
<!--        <input type="text" class="form-control input-sm" id="idevaluacionrefrigerio" name="idevaluacionrefrigerio" style="display: none"     placeholder="rol" value="<?php echo($idevaluacionrefrigerio); ?>">-->
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    <li <?php echo $ocultaxevaluacion ?>> <?php if($crol <> 'adminlogistico') { echo '<a  href="../c_transporte/fc_transporte?idtransporte=0">Solicitud Transporte</a>'; } else{echo '<a  href="../c_transporteadmin/fc_transporteadmin?idtransporteadmin=0">Administrar Trasporte</a>';}  ?>   </li>
...
<!--    <li><a href="#">Something else here</a></li>
  ...
  <ul class="dropdown-menu">
    <li <?php echo $ocultaxevaluacion ?>> <?php if($crol <> 'adminlogistico') { echo '<a  href="../c_refrigerio/fc_refrigerio?idrefrigerio=0">Solicitud Refrigerio</a>'; } else{echo '<a  href="../c_refrigerioadmin/fc_refrigerioadmin?idrefrigerioadmin=0">Administrar Refrigerio</a>';}  ?>   </li>
  ...
  <ul class="dropdown-menu">
    <li <?php echo $ocultaxevaluacion ?>> <?php if($crol <> 'adminlogistico') { echo '<a  href="../c_fotocopia/fc_fotocopia?idfotocopia=0">Solicitud Fotocopia</a>'; } else{echo '<a  href="../c_fotocopiaadmin/fc_fotocopiaadmin?idfotocopiaadmin=0">Administrar Fotocopia</a>';}  ?>   </li>
  ...
  <ul class="dropdown-menu">
    <li <?php echo $ocultaxevaluacion ?>> <?php if($crol <> 'adminlogistico') { echo '<a  href="../c_papeleria/fc_papeleria?idpapeleria=0">Solicitud Papeleria</a>'; } else{echo '<a  href="../c_papeleriaadmin/fc_papeleriaadmin?idpapeleriaadmin=0">Administrar Papeleria</a>';}  ?>   </li>
...
<hr>
  ...
  <div class="row">
      ...
      <div class="col-md-2">
          <input type="text" class="form-control input-sm" id="buscaridfotocopia" onchange="deshabilitarbuscar()" name="buscaridfotocopia"  placeholder="DIGITE ID TRANSPORTE" value="">
      </div>
  ...
  <div class="row">
      <div class="col-lg-10 col-md-offset-2"><label>EL REQUERIMIENTO RESPONDE SUS NECESIDADES?  RECUERDE EN EL MOMENTO DE EVALUAR, SELECCIONAR SI O NO. </label></div>
                      ...
                      <table class="table table-bordered" id="tr24h2" style="table-layout: fixed">
                          <thead>
                              <tr class="success">
                                  ...
                                  <th style="width:100px;">Fecha Fotocopia</th>
                                  <th style="width:100px;">Cantidad</th>
                                  <th style="width:200px;">Observacion</th>
                                  <th style="width:300px;">Respuesta admin</th>
                                  <th style="width:300px;">Observacion admin</th>
                                  <th style="width:120px;">Estado Evaluacion</th>
                                  <th style="width:150px;">respuesta evaluador</th>
                                  <th style="width:200px;">Observacion evaluador</th>
...
function salir()
   {
    ...
    function cancelarfot(idfotocopia)
{
    
                        $.ajax({
                          url: "fc_cancelarfot",
                          type: "GET",
                          data: {vidfotocopia :  idfotocopia,
                                 vidrequeriiento : '4',
                                 videvaluacion : '4' ,
                                 vidaprobado : '4' 
//                                 vobservacionad : $('#observacionad' + idtransporte).val()
                          ...
                          dataType: "html",
                          success : function(obj){   
                              //location.href = "../c_evaluaciontransporte/fc_evaluaciontransporte?idevaluaciontransporte="+ obj;
//                              filtrartabla();
//                          botonguardar();
                           alert('Su requerimiento , fue cancelado!!!');
location.reload();
                          }
                        });                    
 }
        ...
        { mensajedesinco();
                        $.ajax({
                          ...
                          vbuscaridfotocopia : $('#buscaridfotocopia').val(),
...
{ //alert(div + ' juanpis ' + campo);
   ...
   { 
    ...
    validarguardarevaluacionrefrigerio();
}


function validarguardarevaluacionrefrigerio()
{
    if ($('#fechast').val() != '' && $('#horast').val() != '' && $('#lugarpst').val() != ''&& $('#lugarlst').val() != '' && $('#cantidadpt').val() != '' && $('#estadot').val() != '' )
        
    {
       $('#guardarevaluacionrefrigerio').prop('disabled', false);
           
   }
   else
   {
       $('#guardarevaluacionrefrigerio').prop('disabled', true);
...
function fc_guardarevaluacionfotocopia(idfotocopia)
{
    
                        $.ajax({
                          url: "fc_guardarevaluacionfotocopia",
                          type: "GET",
                          data: {vidfotocopia :  idfotocopia,
                                 vrespuestaevaluacion : $('#respuestaevaluacion' + idfotocopia).val(),
                                 vobservacionad : $('#observacionad' + idfotocopia).val()
                                 },    
                          dataType: "html",
                          success : function(obj){   
                              //location.href = "../c_evaluacionrefrigerio/fc_evaluacionrefrigerio?idevaluacionrefrigerio="+ obj;
//                              filtrartabla();
//                          botonguardar();
location.reload();
                          }
    ...
    //NO TOCAR - voler a capitulos                
        ...
        $("#actualizar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(), vvalorevaluacionrefrigerio : $('#valorevaluacionrefrigerio').val()},    
                          dataType: "html",
                          success : function(obj){                      
                          botonactualizar();
                          }
...
function deshabilitarbuscar()
    {
        if(($('#buscarfecha').val() !== '') || ($('#buscaridfotocopia').val() !=='') || ($('#estadorequerimiento').val() !=='') )
        {
            $('#buscar').prop('disabled',false);  
        }
        else
